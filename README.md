...
> ***Life, liberty, and the pursuit of happiness*** means no access to standards of measurement? ***Inalienable rights*** require an ID? A photo ID to use an ***INCH OR OUNCE WITHOUT AN ID?*** A photo ID to make measurements?  ***Gold dollars attract a zillion times more private property (value) to market, a zillion times more value to measure, a zillion times more scrutiny of the dollar (money trail). HOUSES STAY HOME!!! GOLD DOLLARS ARE FOR REWARDING PEOPLE, NOT FOR DISRUPTING THEM, NOT FOR WASTING RESOURCES, NOT FOR SQUANDERING ON HOUSES!!!*** 

> ***Life, liberty, and the pursuit of happiness*** would disrupt housing?
