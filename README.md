...
## ***"Medium of exchange" <ins>LEAVES OUT the medium,</ins> which LEAVES OUT exchange, which LEAVES OUT safe havens (HOMES!!!!!), which LEAVES OUT <ins>HIGH VALUE!!!!!,</ins> which leaves <ins>LOW VALUE OWNING EVERYBODY'S LAND,</ins> no reason for "MEDIUM OF EXCHANGE" but house payments, taxes, and poverty rationing (enough groceries to keep breathing, intoxication) - <ins>LOW VALUE!!!!!</ins>***<br><br><ins>***LOW VALUE wants your land.***</ins>
[Aug31,2025]
